...
'''
There are a few changes by Dhruv Shetty that increased the accuracy by 1.55%
...
print('**************')
print()
(x_train, y_train), (x_test, y_test) = reuters.load_data(num_words=max_words,seed=45,                                          test_split=0.25)
'''
********************************************************************************************
...
********************************************************************************************
'''
print('10 x_train values: ',x_train[0][0:10])
print('10 x_test values: ',x_test[0][0:10])
print('10 y_train values: ',y_train[0:10])
print('10 y_test values: ',y_test[0:10])
...
'''
history = model.fit(x_train, y_train,batch_size=75,epochs=7,verbose=1,validation_split=0.1)
